<!-- Standalone Luxury Menu Drawer Modal -->
<div id="elementor-popup-modal-166" class="biryani-menu-drawer-modal" aria-hidden="true">
  <div class="biryani-drawer-inner">
...
<style>
  ...
  #elementor-popup-modal-166 .elementor-element-7ca967a::before,
  #elementor-popup-modal-166 .elementor-element-a57fe6c::before,
  #elementor-popup-modal-166 .elementor-166::before,
  #elementor-popup-modal-166 ::before,
  #elementor-popup-modal-166 ::after {
    background-image: none !important;
  }
  ...
  #elementor-popup-modal-166 .elementor-element-4ce0183,
  #elementor-popup-modal-166 .popup-stagger,
  #elementor-popup-modal-166 .elementor-element-18dba49 {
...
function initBiryaniDrawer() {
  ...
  // Close on backdrop click (outside the menu links)
  modal.addEventListener("click", function(e){
    if (e.target === modal || e.target.classList.contains("dialog-widget") || e.target.classList.contains("dialog-widget-content") || e.target.classList.contains("dialog-message") || e.target.classList.contains("elementor-166")) {
      closeDrawer();
    }
  });
