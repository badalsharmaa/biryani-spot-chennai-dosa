...
(function(){
  ...
  function goTo(index, direction){
    ...
    if(direction === 'prev'){
      ...
      nextImage.className = 'mps5-photo-layer from-right';
      currentImage.className = 'mps5-photo-layer is-active to-left';
    }
    requestAnimationFrame(() => {
    ...
    if(direction === 'prev'){
      ...
      mobileNextImage.className = 'mps5-photo-layer from-right';
      mobileCurrentImage.className = 'mps5-photo-layer is-active to-left';
    }
    requestAnimationFrame(() => {
      mobileNextImage.classList.add('animate-in');
    });
...
(function(){
  ...
  function tick(){
    ...
    const actionProgress = clamp01((curve - 0.62) / 0.18);
    ...
    const isMobile = window.innerWidth <= 767;
    const scale = isMobile ? lerp(0.96, 1.0, curve) : lerp(0.94, 1.04, curve);
